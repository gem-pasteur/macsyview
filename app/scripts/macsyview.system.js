	...
	var draw = function(json_data, container){
		...
		for (var i = 0; i < presence.length ; i++){
            ...
            $.each(summary[p], function(index, gene){
				...
				p_container.append('<span id="'+ gene.name +'" style="display: inline-block; width:50px;" title="'+ gene.name +'"><div style="background-color:' + gene.color + ';">&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="text-center">' + occurence + '</div></span>');
				p_container.append('&nbsp;');
            });
		}
	};
